...
# loginByHash() - авторизированиться по hash
# 1-й аргумент - id счетчика
# 2-й аргумент - хеш от пароля (см. https://help.mail.ru/top/API/main Аутентификация)
# result = tmr.loginByHash(counter_id, '__MY__HASH__PASSWORD__'.decode('hex'))
